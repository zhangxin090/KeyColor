...
function getSettings(context) {
  ...
  if (response.alertOption == NSAlertFirstButtonReturn) {
    ...
    context.document.showMessage('颜色钥匙: 设置更新!');
  } else {
    return;
  }
}
...
function triggerAlert() {
  ...
  alert.setMessageText("颜色钥匙设置");
  alert.setInformativeText("更新您的颜色下面。一定要使用正确的十六进制值。尚未验证.");
